...
use App\Http\Controllers\Games\SpinData\HoodVsWoolf\HoodVsWoolfWin;
use App\Traits\Providers\PrivateGamesTrait;
use Illuminate\Http\Request;

class HoodvswoolfController extends Controller
{
    ...
    public function spin(Request $request, $token)
    {
        ...
        return self::SpinStructure($token, $settingGame, $pull, HoodVsWoolfLose::getLose(), HoodVsWoolfDemo::getDemo(), HoodVsWoolfWin::getWin(), HoodVsWoolfBonus::getBonus());
    }
