<template>
    <nav class="fixed top-0 z-50 w-full navtop-color custom-box-shadow border-solid border-b border-1 border-gray-700">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start py-3">
                    ...
                    <div class="items-center justify-center text-gray-500 hidden md:flex me-4">
                        ...
                        <RouterLink :to="{ name: 'sportPage' }" active-class="border-b-2 border-primary text-white"  class="flex gap-2 flex-row w-[50%] cursor-pointer items-center px-2 py-3 justify-center">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" width="16px" height="16px"
                                viewBox="0 0 1706.66 1706.66" xml:space="preserve" xmlns:svgjs="http://svgjs.com/svgjs">
                                <g>
                                    <path
                                        ...
                                        fill="currentColor" data-original="#ff7a1b"></path>
                                    <g fill="#ff5329">
                                        <path
                                            ...
                                            fill="#040404" data-original="#ff5329"></path>
                                        <path
                    ...
                    <a v-if="setting" href="/" class="flex md:mr-24 md:ml-3">
                        ...
                        <div class="block sm:hidden">
                            <img :src="`/storage/`+setting.software_logo_black" alt="" class="w-auto max-h-[25px] mr-3 block dark:hidden" /> <!-- Altere o tamanho aqui -->
                            <img :src="`/storage/`+setting.software_logo_white" alt=""  class="w-auto max-h-[25px] mr-3 hidden dark:block" /> <!-- Altere o tamanho aqui -->
                        </div>
                    </a>
                </div>
