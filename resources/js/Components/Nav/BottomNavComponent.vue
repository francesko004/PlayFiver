<template>
    <div class="flex sm:hidden">
        <div class="fixed z-40 w-full navtop-color h-16 -translate-x-1/2 bg-white border-t-1 border-t border-gray-700 bottom-0 left-1/2">
            <div class="grid h-full grid-cols-5 mx-auto">
                ...
                <div class="flex items-center justify-center">
                    <button @click="$router.push('/profile/deposit')" data-tooltip-target="tooltip-new" type="button" class="inline-flex items-center justify-center w-[50px] h-[50px] font-medium bg-green-700 rounded-lg hover:bg-green-700 group focus:ring-4 focus:ring-green-300 focus:outline-none dark:focus:ring-blue-800 text-[20px]">
                ...
                <button @click="$router.push('/profile/affiliate')" data-tooltip-target="tooltip-sport" type="button" class="inline-flex flex-col items-center justify-center px-5 rounded-r-full hover:bg-gray-50 dark:hover:bg-gray-800 group">
                    <i class="fa-duotone fa-users mb-1 text-xl"></i>
