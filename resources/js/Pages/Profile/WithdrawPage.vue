                ...
                <div class="relative col-span-2">
                    <div
                        v-if="
                            ...
                            isLoading === false
                        "
                        class="flex flex-col w-full p-4 bg-gray-200 border border-gray-300 rounded shadow-lg dark:border-gray-700 hover:bg-gray-300/20 dark:bg-gray-700"
                    >
                        <form
    ...
    methods: {
        ...
        submitWithdrawBank: function (event) {
            ...
            _this.withdraw.amount =
                parseFloat(_this.withdraw.amount?.replace(/\D/g, "")) / 100;
            _this.withdraw.cpf = _this.withdraw.cpf.replace(/\D/g, "");
